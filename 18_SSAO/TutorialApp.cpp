...
bool TutorialApp::CreateShaders()
{
	// Geometry pass
	{
		...
		HR_T(CompileShaderFromFile(L"../Shaders/18_GBufferVS.hlsl", "main", "vs_4_0", vsBlob.GetAddressOf()));
		...
		HR_T(CompileShaderFromFile(L"../Shaders/18_GBufferPS.hlsl", "main", "ps_4_0", psBlob.GetAddressOf()));
	...
	{
		ComPtr<ID3DBlob> vsBlob;
		HR_T(CompileShaderFromFile(L"../Shaders/18_QuadVS.hlsl", "main", "vs_4_0", vsBlob.GetAddressOf()));
		...
		HR_T(CompileShaderFromFile(L"../Shaders/18_DirectionLightVS.hlsl", "main", "vs_4_0", vsDirLightBlob.GetAddressOf()));
		HR_T(m_pDevice->CreateVertexShader(vsDirLightBlob->GetBufferPointer(), vsDirLightBlob->GetBufferSize(), nullptr, m_pDirectionLightVS.GetAddressOf()));

		// Point Light Volume Vertex Shader
		ComPtr<ID3DBlob> vsPointLightBlob;
		HR_T(CompileShaderFromFile(L"../Shaders/18_PointLightVS.hlsl", "main", "vs_4_0", vsPointLightBlob.GetAddressOf()));
		HR_T(m_pDevice->CreateVertexShader(vsPointLightBlob->GetBufferPointer(), vsPointLightBlob->GetBufferSize(), nullptr, m_pPointLightVS.GetAddressOf()));

		ComPtr<ID3DBlob> psBlob;
		HR_T(CompileShaderFromFile(L"../Shaders/18_PointLightPS.hlsl", "main", "ps_4_0", psBlob.GetAddressOf()));
		...
		HR_T(CompileShaderFromFile(L"../Shaders/18_DirectionLightPS.hlsl", "main", "ps_4_0", psDirBlob.GetAddressOf()));
		...
		HR_T(CompileShaderFromFile(L"../Shaders/18_SolidPS.hlsl", "main", "ps_4_0", psWireBlob.GetAddressOf()));
